...
const Contact = () => {
  return (
    <div className="grid grid-cols-1 h-[191.74px] xl:h-[282.75px] 2xl:h-[377px] mb-[100px">
      ...
      <div className="flex  lg:justify-between  flex-col lg:items-center  lg:flex-row ">
        <div className="text-[#091F5B] w-full mb-[24px]">
          <h3 className=" text-[14px] leading-[16.94px] font-medium  tracking-tighter xl:text-[18px] xl:leading-[22.5px] xl:font-medium  xl:tracking-tighter 2xl:text-[24px] 2xl:leading-[30px] 2xl:font-medium  2xl:tracking-tighter mb-[8px]">
            {/* leading-[16.94] */}
            nebula digital
          </h3>
          <p
