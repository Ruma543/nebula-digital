...
const ExpertPart2 = () => {
  return (
    <div className="mb-[160px] 1xs:mb-[160px] sm:mb-[160px] lg:mb-[120px] 2xl:mb-[160px] lg:flex lg:justify-between  bg-[#FFFFFF] rounded-[24px] 1xs:rounded-[24px] sm:rounded-[24px] lg:rounded-[36px] 2xl:rounded-[48px]">
