...
const Insight = () => {
  ...
  return (
    <div>
      <div className="px-[16.75px] sm:px-[20px]  xl:px-[54px] 2xl:px-[72px]  bg-[#EDF0F5] rounded-t-[32px] xl:rounded-t-[52.5px] 2xl:rounded-t-[70px] pt-10 xl:pt-18  2xl:pt-24  text-primary  pb-[60px] xl:pb-[36px]  2xl:pb-[48px] ">
        {/* -mb-100  sm:mb-[96px] xl:mb-[120px] 2xl:mb-[160px]  */}
