...
const SlideCard = ({ data }) => {
  ...
  return (
    <div
      ...
      className=" h-[389px] rounded-[24px] xl:h-[364.5px] xl:rounded-[22.5px]  2xl:h-[486px] 2xl:rounded-[30px]  text-white border-8 border-white mr-4 pl-[20px] pt-[20px] pr-[40px] pb-[32px] xl:px-[18px] xl:pt-[18px] xl:pb-[16.5px] 2xl:px-[24px] 2xl:pt-[18px] 2xl:pb-[16.5px]"
      style={{ backgroundColor: color, color: textColor }}
      key={id}
    >
      {/* <p className="text-blue-800">{data.color}</p> */}
